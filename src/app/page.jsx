...
const Homepage = () => {
  return (
    ...
    >
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 overflow-auto items-center justify-center">
        {/* IMAGE CONTAINER */}
        ...
        <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center text-black dark:text-neutral-200">
          ...
          <div className="w-full flex gap-4 py-4">
            ...
            <button className="p-4 rounded-lg ring-1 ring-black dark:ring-neutral-200"><Link href="/contact">Contact Me</Link></button>
          </div>
        </div>
      </div>
    </motion.div>
