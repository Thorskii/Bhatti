    ...
    return (
        <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-12 xl:px-16 text-xl text-black dark:text-neutral-200">
            ...
            <div className="md:hidden lg:flex w-1/3 xl:justify-center">
                <Link href="/" className="sm:text-xl md:text-2xl lg:text-4xl p-1 font-semibold flex items-center justify-center">
                    <span className="text-black dark:text-white mr-2">GURPREET BHATTI</span>
                </Link>
            </div>
            {/* SOCIALS */}
            ...
            <div className="md:hidden">
                ...
                {/* MENU LIST */}
                {open && (
                    <motion.div variants={listVariants} initial="closed" animate="opened" className="absolute top-0 left-0 w-screen h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-4xl z-50">
                    {links.map(link=>(
